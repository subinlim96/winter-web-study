...
<body>
  ...
  여기에 웹페이지에 표시할 콘텐츠(태그)를 입력해주세요
     <script></script> <!-- script 태그는 보통 body 태그 안에서 마지막 부분에 넣는다. -->
</body>
...
- data-원하는 이름="" : 요소의 데이터를 지정 -> 따옴표 안에 있는 내용이 상자 안의 내용물(컴퓨터가 보는 내용)
     ...
     <img width="350" height="248" alt="image" src="https://github.com/user-attachments/assets/f1c9f416-49cb-4e75-a0b3-43f9d65e4103" />
